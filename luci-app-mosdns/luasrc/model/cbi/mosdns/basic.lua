...
o = s:taboption("basic", Flag, "prefer_ipv4", translate("DNS resolution prefers IPv4"), translate("IPv4 is preferred for DNS resolution of dual-stack addresses, and is not affected when the destination is IPv6 only"))
o:depends( "configfile", "/etc/mosdns/config.yaml")
o.default = true
