...
local client_ip_cn_file = "/etc/mosdns/rule/client-ip-cn.txt"
...
s:tab("client_ip_cn_list", translate("Client IP CN Direct"))
...
o = s:taboption("client_ip_cn_list", TextValue, "client_ip_cn", "", "<font color='red'>" .. translate("These client IPs will use local DNS for direct connection. Please input IP addresses or CIDR ranges, one per line. For example: 192.168.1.0/24") .. "</font>" .. "<font color='#00bd3e'>" .. translate("<br>The list of rules only apply to 'Default Config' profiles.") .. "</font>")
o.rows = 15
o.wrap = "off"
o.cfgvalue = function(self, section) return nixio.fs.readfile(client_ip_cn_file) or "" end
o.write = function(self, section, value) nixio.fs.writefile(client_ip_cn_file, value:gsub("\r\n", "\n")) end
o.remove = function(self, section, value) nixio.fs.writefile(client_ip_cn_file, "") end
o.validate = function(self, value)
    return value
end
